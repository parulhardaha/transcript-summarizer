...
AI Transcript Summarizer generates concise summaries from long transcripts using AI-powered text summarization techniques.
...
2. Enter a custom prompt (Example: `Summarize in 5 bullet points`).

3. Click the **Generate Summary** button to process the transcript.
